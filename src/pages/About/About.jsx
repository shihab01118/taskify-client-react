      ...
      <div className="max-w-6xl mx-8 md:mx-16 lg:mx-auto pt-[83px] mb-20">
        ...
        <div data-aos="fade-up" className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            shared vision to create a task management platform that is
            intuitive, flexible, and adaptable to various needs. We are
            dedicated to continuously improving our platform based on user
